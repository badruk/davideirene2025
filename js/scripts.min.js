...
$(document).ready(function() {
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        ...
        $("#alert-wrapper").html(alert_markup("info", "<strong>Un momento di pazienza!</strong> Stiamo salvando la tua risposta.")), "c8660480dac9ef08be20dc3ce1747c52" !== MD5($("#invite_code").val()) && "2ac7f43695eb0479d5846bb38eec59cc" !== MD5($("#invite_code").val()) ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Mi dispiace!</strong> Il tuo codice non è corretto.")) : $.post("https://script.google.com/macros/s/AKfycbxGky1jmRnEtXyqhi81CbIVAe7pOKl9l44M6xCzoaCQecvxG0m3HHew0WG9_sYbI5z2/exec", t).done(function(e) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Gestione pulsanti "Show info" e "Mostra mappa" per entrambe le mappe
    document.querySelectorAll('.toggle-map-content').forEach(button => {
