...
// Data dell'evento: 7 settembre 2025 alle 10:30
const eventDate = new Date('September 7, 2025 10:00:00').getTime();
...
function updateCountdown() {
    ...
    let countdownText;
    if (distance < 0) {
        countdownText = "L'evento è iniziato!";
    } else {
        countdownText = `${days} Giorni ${hours.toString().padStart(2, '0')}h:${minutes.toString().padStart(2, '0')}m:${seconds.toString().padStart(2, '0')}s`;
    }
    
    // Aggiornamento del DOM
    document.getElementById('countdown-text').innerHTML = "<h3countdown>" + countdownText + "</h3countdown>";
}
