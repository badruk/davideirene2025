...
$(document).ready(function() {
    ...
    var r = createCalendar({
        ...
        data: {
            ...
            address: "FIVIZZANO, 54013 LOC. CERIGNANO MS",
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        ...
        $("#alert-wrapper").html(alert_markup("info", "<strong>Un momento di pazienza!</strong> Stiamo salvando la tua risposta.")), "b0e53b10c1f55ede516b240036b88f40" !== MD5($("#invite_code").val()) && "2ac7f43695eb0479d5846bb38eec59cc" !== MD5($("#invite_code").val()) ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Mi dispiace!</strong> Il tuo codice non è corretto.")) : $.post("https://script.google.com/macros/s/AKfycbyuOzlOk3JcItQgn0suLXqF-HiRxa3b3-SwzwMxSTGjmy80M2dkLwYEHvCt_dfX31T6/exec", t).done(function(e) {
